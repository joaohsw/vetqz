...
Gerencia os buckets 'pdfs' e 'audio'.
"""
...
def upload_pdf(file_bytes: bytes, original_filename: str) -> str:
    """
    Faz upload do PDF ao bucket 'pdfs' no Supabase Storage.
    ...
    Returns:
        Path do arquivo no Storage (ex: "pdfs/abc123.pdf").
    """
